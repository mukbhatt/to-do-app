...
function createTaskId() {
  // temporary function that we'll use before MongoDB is used, to track task IDs
  const taskId = nextTaskId.toString();
  nextTaskId += 1; // nextTaskId = nextTaskId + 1
  return taskId;
}
...
// Make a task complete API route
...
// Make a task incomplete API route
